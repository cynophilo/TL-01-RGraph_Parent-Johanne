...
RGraph.Horseshoe = function (conf) {
  ...
  this.context = this.canvas.getContext
    ? this.canvas.getContext("2d", {
        alpha: typeof id === "object" && id.alpha === false ? false : true,
      })
    : null;
  ...
  this.draw = function () {
    ...
    this.centerx =
      ...
      this.marginLeft;
    this.centery =
      (this.canvas.height - this.marginBottom - this.marginTop) / 2 +
      this.marginTop;
  ...
  this.drawMeter = function () {
    ...
    this.path(
      ...
      typeof properties.endsRadius === "number"
        ? properties.endsRadius
        : properties.width * 1.5,
      RGraph.TWOPI,
      typeof properties.endsColor === "string"
        ? properties.endsColor
        : properties.colors[0]
    );
  ...
  this.drawLabels = function () {
    ...
    RGraph.text({
      ...
      text: properties.labelsCenterSpecific
        ? properties.labelsCenterSpecific
        : RGraph.numberFormat({
            object: this,
  ...
  this.getAngle = function (value) {
    if (typeof value === "number") {
      ...
      var angle =
        ((value - this.min) / (this.max - this.min)) * RGraph.TWOPI -
        RGraph.HALFPI;
